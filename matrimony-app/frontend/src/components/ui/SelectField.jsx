    ...
    <div className={className}>
      ...
      <div className="relative">
        ...
        <select
          id={inputId}
          ref={ref}
          className={`input-base appearance-none pr-10 ${icon ? 'pl-10' : ''} ${stateClass}`}
          aria-invalid={!!error}
        ...
        <span className="absolute right-3 top-1/2 -translate-y-1/2 pointer-events-none text-[var(--ink-faint)]" aria-hidden="true">
